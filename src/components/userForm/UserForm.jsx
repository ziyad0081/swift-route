...
function UserForm(props){
    ...
    const select = <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={selectedValue} onChange={(e)=>{setSelected(e.target.value)}}>
    {options.map((option) => (
